...
public class PlayerMovementLuigi : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Horizontal < 0.0f) transform.localScale = new Vector3(-0.5565351f, 0.5565351f, 0.5565351f);
        else if (Horizontal > 0.0f) transform.localScale = new Vector3(0.5565351f, 0.5565351f, 0.5565351f);
